...
import serial
import array
from PyTango import AttrQuality, AttrWriteType, DispLevel, DevState, DebugIt, DevVarCharArray, DevUShort, DevUChar
from PyTango.server import Device, DeviceMeta, attribute, command, pipe, device_property, class_property, run
...
#--------- Add you global variables here --------------------------
    ...
    def is_open_allowed(self):
        if self.get_state() in [DevState.ON,
                                DevState.FAULT]:
    ...
    def is_flush_input_allowed(self):
        if self.get_state() in [DevState.FAULT,
                                DevState.OFF]:
            #   End of Generated Code
            #   Re-Start of Generated Code
            return False
