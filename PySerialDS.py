...
#------------------------------------------------------------------
	...
	# -----------------
		...
		self.terminatorchar = chr(3)    # end of text PySerial.TERMINATORCHAR[0]
...
#	WriteRead command:
#
#	Description: Write & Read a the string to/from the serial line
#
...
#------------------------------------------------------------------
	...
	# 	print (s)
	# 	value = chr(2) + s + chr(3) #self.terminatorchar
	# 	self.debug_stream("string %s" % str("string "+str(value)))
	# 	self.serial.write(value)
	
	def Write(self, cmd):
	#	self.info_stream("In %s::Write()" % self.get_name())
	#	self.debug_stream("char array %s" % str(cmd))
	#	print (cmd)
...
#	ReadUntil command:
#
#	Description: Read until character of end
#	
#	argout: DevVarCharArray	Characters readed
#------------------------------------------------------------------
	def ReadUntil(self,c):
		#self.info_stream("In %s::ReadUntil()" % self.get_name())
		#	Add your own code here
		argout =  []
